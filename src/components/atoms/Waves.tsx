  ...
  return (
    <div className={clsx("block w-full -mt-[1px]", className)}>
      <svg viewBox="0 0 1440 170">
        <path d="M0,128L48,138.7C96,149,192,171,288,149.3C384,128,480,64,576,48C672,32,768,64,864,74.7C960,85,1056,75,1152,80C1248,85,1344,107,1392,117.3L1440,128L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path>
      </svg>
    </div>
  );
};
